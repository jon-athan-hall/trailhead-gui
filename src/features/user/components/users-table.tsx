...
export function UsersTable({ onManageRoles, onDelete }: UsersTableProps) {
  ...
  // eslint-disable-next-line react-hooks/incompatible-library -- TanStack Table returns non-memoizable functions; React Compiler optimization is intentionally skipped here.
